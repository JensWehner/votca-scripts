        ...
        for vectorA in vectorsA:
                for vectorB in vectorsB:
                        ...
                        if angularA >= angularB:               
                                ...
                                print overlap(vectorA,vectorB),"=",factor+prefactor0(ind)+overlap(vectorAm1,vectorB)+prefactor1(vectorAm1[ind])+overlap(vectorAm2,vectorB)+prefactor1(vectorB[ind])+overlap(vectorAm1,vectorBm1)+';'     
                        else:
                                ...
                                print overlap(vectorA,vectorB),"=",factor+prefactor0(ind)+overlap(vectorA,vectorBm1)+prefactor1(vectorBm1[ind])+overlap(vectorA,vectorBm2)+prefactor1(vectorA[ind])+overlap(vectorAm1,vectorBm1)+';' 
        print '}'
        print''
